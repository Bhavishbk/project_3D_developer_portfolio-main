  ...
  return (
    <motion.div variants={fadeIn("up", "spring", index * 0.5, 0.75)}>
      <Tilt
        ...
        scale={1}
        transitionSpeed={450}
        className="bg-tertiary p-5 rounded-2xl sm:w-[360px] w-full shadow-lg hover:shadow-2xl"
      >
        <div className="relative w-full h-[230px] group rounded-2xl overflow-hidden">
          <img
            src={image}
            alt={name}
          ...
          <div className="absolute left-4 bottom-4 text-white z-10 opacity-0 group-hover:opacity-100 transition-opacity">
